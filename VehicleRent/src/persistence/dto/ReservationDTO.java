...
public class ReservationDTO {
	...
	public ReservationDTO(int id, LocalDateTime pickupDate,
			LocalDateTime returnDate, int rentalModality,
			String customerDni, String categoryName, int idPickupBranchOffice,
	...
	public int getRentalModality() {
		return rentalModality;
	}

	public void setRentalModality(int rentalModality) {
		this.rentalModality = rentalModality;
	}
